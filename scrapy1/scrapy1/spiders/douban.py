...
class DoubanSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i_item in movie_list:
            ...
            douban_item['no'] = i_item.xpath(".//div[@class='item']//em/text()").extract()
            douban_item['movie_name'] = i_item.xpath(
                ".//div[@class='info']/div[@class='hd']/a/span[1]/text()").extract()
            ...
            douban_item['numbers'] = i_item.xpath(".//div[@class='star']//span[4]/text()").extract()
            douban_item['describe'] = i_item.xpath(".//p[@class='quote']//span[@class='rating_num']/text()").extract()
            yield douban_item
